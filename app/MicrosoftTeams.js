...
(function (appInitialization) {
    ...
    function notifyAppLoaded() {
        internalAPIs_1.ensureInitialized();
        communication_1.sendMessageToParent('appInitialization.appLoaded', [constants_1.version]);
    }
    ...
    function notifySuccess() {
        internalAPIs_1.ensureInitialized();
        communication_1.sendMessageToParent('appInitialization.success', [constants_1.version]);
    }
    ...
    function notifyFailure(appInitializationFailedRequest) {
        internalAPIs_1.ensureInitialized();
        communication_1.sendMessageToParent('appInitialization.failure', [
...
(function (videoApp_1) {
    ...
    var VideoApp = /** @class */ (function () {
         ...
         */
        VideoApp.prototype.registerForVideoFrame = function (frameCallback, format) {
            internalAPIs_1.ensureInitialized(constants_1.FrameContexts.content, constants_1.FrameContexts.task);
            this.videoFrameCallback = frameCallback;
            this.setupConnection();
            communication_1.sendMessageToParent('videoApp.sendMessagePortToMainWindow', [format]);
        };
        /**
    ...
    function registerForVideoFrame(frameCallback, format) {
